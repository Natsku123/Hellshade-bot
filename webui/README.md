...
Next.js + TypeScript dashboard that replaced the legacy Vue frontend and FastAPI GraphQL backend.
...
Use the root-level `docker-compose.yml` to run bot + db + traefik + this app.
