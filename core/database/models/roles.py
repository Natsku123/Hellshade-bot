...
class Role(Base):
    ...
    server: Mapped["Server"] = relationship("Server", uselist=False)
    members: Mapped[list["Member"]] = relationship("Member", secondary="member_role_association", back_populates="roles")
